...
from Myambumy.extensions import db, avatars
from Myambumy.decorations import confirm_required,permission_required
from Myambumy.utils import redirect_back,generate_token, validate_token, redirect_back, flash_errors
from Myambumy.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
